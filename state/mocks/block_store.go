...
// LoadBlockConsensusPartSetPart provides a mock function with given fields: height, index
func (_m *BlockStore) LoadBlockConsensusPartSetPart(height int64, index int) *types.Part {
...
// SaveBlockWithConsensusPartSet provides a mock function with given fields: block, consensusPartSet, fullPartSet, seenCommit
func (_m *BlockStore) SaveBlockV2(block *types.Block, consensusPartSet *types.PartSet, fullPartSet *types.PartSet, seenCommit *types.Commit) {
	_m.Called(block, consensusPartSet, fullPartSet, seenCommit)
}
