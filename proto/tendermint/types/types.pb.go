...
type Data struct {
	...
	RootCollection   []byte   `protobuf:"bytes,2,opt,name=root_collection,json=rootCollection,proto3" json:"root_collection,omitempty"`
	ExtraCollections [][]byte `protobuf:"bytes,3,rep,name=extra_collections,json=extraCollections,proto3" json:"extra_collections,omitempty"`
}
...
func (m *Data) GetRootCollection() []byte {
	if m != nil {
...
func (m *Data) GetExtraCollections() [][]byte {
	if m != nil {
...
var fileDescriptor_d3a6e55e2345de56 = []byte{
	...
	,
}
